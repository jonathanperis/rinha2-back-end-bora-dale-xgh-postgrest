...
if (reportsList) {
  const apiUrl = 'https://api.github.com/repos/jonathanperis/rinha2-back-end-postgrest/contents/docs/reports?ref=main';
  ...
  fetch(apiUrl)
    ...
    .then(data => {
      ...
      htmlFiles.forEach(file => {
        ...
        const publicUrl = `https://jonathanperis.github.io/rinha2-back-end-postgrest/reports/${file.name}`;
